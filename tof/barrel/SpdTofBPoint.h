...
#ifndef __SPDTOFBPOINT_H__
#define __SPDTOFBPOINT_H__ 
...
class SpdTofBPoint : public FairMCPoint {
...
public:
  ...
  SpdTofBPoint(Int_t trackID, Int_t detID,
  ...
  SpdTofBPoint(const SpdTofBPoint& point)   { *this = point; }

  virtual ~SpdTofBPoint();
...
private:
  ...
  ClassDef(SpdTofBPoint,1)
  
};

#endif  /* __SPDTOFBPOINT_H__ */
