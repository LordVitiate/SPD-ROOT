...
ClassImp(SpdRsTEC2woFEB)

//_____________________________________________________________________________________
SpdRsTEC2woFEB::SpdRsTEC2woFEB(): 
...
//_____________________________________________________________________________________
SpdRsTEC2woFEB::SpdRsTEC2woFEB(const char* name, Bool_t active):
...
//_____________________________________________________________________________________
void SpdRsTEC2woFEB::Initialize()
{
  cout << "\n*******************************************************************************" << endl;
  cout << "************************* SpdRsTEC2woFEB::Initialize *******************************" << endl;
  cout << "*******************************************************************************\n" << endl;
...
//_____________________________________________________________________________________
void SpdRsTEC2woFEB::Reset()
{
  fPointCollection->Clear();
}

//_____________________________________________________________________________________
void SpdRsTEC2woFEB::Register()
{
  if (fGeoMapper && fGeoMapper->GetGeoType() < 1) return;
    
  FairRootManager::Instance()->Register(fOutDataPointObject,"SpdRsTEC2woFEB", 
                                        fPointCollection, kTRUE);
}

//_____________________________________________________________________________________
Bool_t SpdRsTEC2woFEB::ProcessHits(FairVolume* vol)
{
  //cout << "<SpdRsTEC2woFEB::ProcessHits> " << gMC->CurrentVolPath() << endl;
       ...
       gMC->IsTrackDisappeared()   ) 
  {
    ...
    //cout << "<SpdRsTEC2woFEB::AddHit> " << fPointCollection->GetEntriesFast() << endl;
...
//_____________________________________________________________________________________
void SpdRsTEC2woFEB::EndOfEvent()
{
  Reset();
}

//_____________________________________________________________________________________
void SpdRsTEC2woFEB::FinishRun() 
{
...
//_____________________________________________________________________________________
void SpdRsTEC2woFEB::ConstructGeometry()
{   
  ...
  cout << "\n*******************************************************************************" << endl;
  cout << "********************** SpdRsTEC2woFEB::ConstructGeometry ***************************" << endl;
...
//_____________________________________________________________________________________
void SpdRsTEC2woFEB::ConstructDetector()
{
  ...
  if (!fModule) 
  {       
      cout << "-E- <SpdRsTEC2woFEB::ConstructGeometry> "            
...
//_____________________________________________________________________________________
TGeoVolume* SpdRsTEC2woFEB::BuildModule(const char* name, TString mat, 
...
{   
  ...
  if (!material) {       
      cout << "-E- <SpdRsTEC2woFEB::BuildModule> "             
...
//_____________________________________________________________________________________
TGeoVolume* SpdRsTEC2woFEB::CreateFirstLayer(Double_t rsInnerRadius, Double_t rsOuterRadius, Double_t rsThickness) 
{
  //
  ...
  SpdRsTEC2GeoMapper* mapper = dynamic_cast<SpdRsTEC2GeoMapper*>(fGeoMapper);
  if (!mapper) {
      cout << "-E- <SpdRsTEC2woFEB::CreateFirstLayer> Unknown mapper: " << mapper->ClassName() << endl;
      return 0;
  }
...
//_____________________________________________________________________________________
TGeoVolume* SpdRsTEC2woFEB::CreateRegularLayer(Int_t layerN, Double_t rsInnerRadius, Double_t rsOuterRadius, Double_t rsThickness) 
{
  //
  ...
  SpdRsTEC2GeoMapper* mapper = dynamic_cast<SpdRsTEC2GeoMapper*>(fGeoMapper);
  if (!mapper) {
      cout << "-E- <SpdRsTEC2woFEB::CreateRegularLayer> Unknown mapper: " << mapper->ClassName() << endl;
      return 0;
  }
...
//_____________________________________________________________________________________
TGeoVolume* SpdRsTEC2woFEB::CreateLastLayer(Int_t layerN, Double_t rsInnerRadius, Double_t rsOuterRadius, Double_t rsThickness) 
{
  //
  ...
  SpdRsTEC2GeoMapper* mapper = dynamic_cast<SpdRsTEC2GeoMapper*>(fGeoMapper);
  if (!mapper) {
      cout << "-E- <SpdRsTEC2woFEB::CreateLastLayer> Unknown mapper: " << mapper->ClassName() << endl;
      return 0;
  }
...
//_____________________________________________________________________________________
TGeoVolume* SpdRsTEC2woFEB::CreateMDT(Double_t length) 
{
  //
  ...
  SpdRsTEC2GeoMapper* mapper = dynamic_cast<SpdRsTEC2GeoMapper*>(fGeoMapper);   
  if (!mapper) {       
      cout << "-E- <SpdRsTEC2woFEB::CreateMDT> Unknown mapper: " << mapper->ClassName() << endl;       
      return 0;   
  } 
...
//_____________________________________________________________________________________
SpdGeoMapper* SpdRsTEC2woFEB::GetMapper() 
{
...
//_____________________________________________________________________________
Bool_t SpdRsTEC2woFEB::LoadParsFrom(SpdParSet* params) 
{
...
//_____________________________________________________________________________________
TString SpdRsTEC2woFEB::GetDataOut(Int_t n) const 
{ 
...
//_____________________________________________________________________________________
TClonesArray* SpdRsTEC2woFEB::GetCollection(Int_t iColl) const 
{ 
...
//_____________________________________________________________________________________
Double_t SpdRsTEC2woFEB::GetCapacity() const 
{ 
...
//_____________________________________________________________________________________
Double_t SpdRsTEC2woFEB::GetMass() const 
{ 
   return (fModule) ? GetCapacity()*GetDensity() : 0;
}

//_____________________________________________________________________________________
Double_t SpdRsTEC2woFEB::GetDensity() const 
{   
   return (fModule) ? fModule->GetMaterial()->GetDensity() : 0; 
} 

//_____________________________________________________________________________________ 
TString SpdRsTEC2woFEB::GetMaterialName() const // private
{ 
   return (fModule) ? fModule->GetMaterial()->GetName() : "";
}

//_____________________________________________________________________________
void SpdRsTEC2woFEB::Print(Option_t*) const
{
   SpdDetector::Print("");
