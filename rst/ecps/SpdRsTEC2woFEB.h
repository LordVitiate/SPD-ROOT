...
#ifndef __SpdRsTEC2woFEB_H__
#define __SpdRsTEC2woFEB_H__
...
class SpdRsTEC2woFEB: public SpdDetector { 

public:

    SpdRsTEC2woFEB(const char* Name, Bool_t Active);
    SpdRsTEC2woFEB();
  
    virtual ~SpdRsTEC2woFEB();
...
private:
    ...
    SpdRsTEC2woFEB(const SpdRsTEC2woFEB&);
    SpdRsTEC2woFEB& operator=(const SpdRsTEC2woFEB&);
    ...
    ClassDef(SpdRsTEC2woFEB,1)
};

#endif /* __SpdRsTEC2woFEB_H__ */
