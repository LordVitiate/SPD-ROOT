...
#ifndef __SPDRSTB_H__
#define __SPDRSTB_H__
...
class SpdRsTB: public SpdDetector { 

public:

    SpdRsTB(const char* Name, Bool_t Active);
    SpdRsTB();
    ...
    FairModule* CloneModule() const { return new SpdRsTB(*this); }
...
private:
    ...
    //SpdRsTB(const SpdRsTB&);
    SpdRsTB& operator=(const SpdRsTB&);
