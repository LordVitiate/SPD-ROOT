...
#ifndef __SPDBBCPOINT_H__
#define __SPDBBCPOINT_H__ 
...
class SpdBbcPoint : public FairMCPoint {
...
public:
  ...
  SpdBbcPoint(const SpdBbcPoint& point) { *this = point; }
...
private:
  ...
  ClassDef(SpdBbcPoint,1)
  
};

#endif  /* __SPDBBCPOINT_H__ */
