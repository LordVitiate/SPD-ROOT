...
class Exception : public std::exception {
 ...
 public:
  ...
  static void        clearEmessg() { emessg_.clear(); }
  static int         getNEmessg()  { return emessg_.size(); }
  static const char* getEmessg(int i);
  static void        setEmessgflag(bool f) { emessgflag_ = f; }
  static std::set<std::string>& getEmessg() { return emessg_;}
  
 private:

  static void addEmessg(std::string& msg);   
  ...
  static std::set<std::string> emessg_;
  static bool emessgflag_;
