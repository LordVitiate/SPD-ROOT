...
#ifndef __SPDTSSECGEOMAPPER_H__
#define __SPDTSSECGEOMAPPER_H__
...
class SpdTsSECGeoMapper: public SpdGeoMapper {

public:
  
    SpdTsSECGeoMapper();
    SpdTsSECGeoMapper(TString prefix);
    
    virtual ~SpdTsSECGeoMapper();
    
    static SpdTsSECGeoMapper* Instance();
    static SpdTsSECGeoMapper* GetMapper();
...
private:
    ...
    /* data members */
    static SpdTsSECGeoMapper* fInstance;
    
    void SetParameters_1(Bool_t reinit);
      
    ClassDef(SpdTsSECGeoMapper,1) 
};

#endif  /* __SPDTSSECGEOMAPPER_H__ */
