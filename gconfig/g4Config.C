...
///  
///    Hadron = FTFP_BERT FTFP_BERT_TRV FTFP_BERT_HP FTFP_INCLXX FTFP_INCLXX_HP FTF_BIC 
///    LBE QBBC QGSP_BERT QGSP_BERT_HP QGSP_BIC QGSP_BIC_HP QGSP_FTFP_BERT QGSP_INCLXX 
///    QGSP_INCLXX_HP QGS_BIC Shielding ShieldingLEND
///  
...
//                              "stepLimiter");
   ...
   /* Create external decayer (Pythia) */
   ...
   TString config_dir(gSystem->Getenv("VMCWORKDIR"));
   TString configm = config_dir + "/gconfig/g4config.in";
   
   cout << "-I- <g4Config> Using g4conf macro: " << configm << endl;

   /* Set geant4 specific stuff */
   
   geant4->SetMaxNStep(100000);  // default is 30000
