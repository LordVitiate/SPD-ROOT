  ...
  fCell(0)
{
    ...
    fNDataOut = 1;
    fOutDataPointObject = "SpdEcalECPoint"; 
}

//_____________________________________________________________________________________
SpdEcalEC::SpdEcalEC(const char* name, Bool_t active):
...
//_____________________________________________________________________________________
void SpdEcalEC::Initialize()
{
  cout << "\n*******************************************************************************" << endl;
  cout << "************************* SpdEcalEC::Initialize *****************************" << endl;
  cout << "*******************************************************************************\n" << endl;
...
//_____________________________________________________________________________________
void SpdEcalEC::Register()
{
  if (!fGeoMapper) return;
  
  if (!fEnableWritingPointsScint) return;
  
  FairRootManager::Instance()->Register(fOutDataPointObject,"SpdEcalEC", 
                                        fPointCollection, kTRUE);
}

//_____________________________________________________________________________________
Bool_t SpdEcalEC::ProcessHits(FairVolume* vol)
{
  //cout << "<SpdEcalEC::ProcessHits> " << endl;
  ...
  // Create SpdEcalECPoint at exit of active volume
       ...
       gMC->IsTrackDisappeared()   ) 
  {
    ...
    fDetID =  kSpdEcalTEC;
    fEndcapID = parser.Num(2, true) - 1; //0: negative Z, +1: positive Z
...
//_____________________________________________________________________________________
void SpdEcalEC::AddHit() 
{
  static Bool_t addhit = (fOutDataPointObject == "SpdEcalECPoint") ? kTRUE : kFALSE;
  ...
  //cout << "SpdEcalEC::AddHit: Adding hit: " << fTrackID << " " << fDetID << " " << fEndcapID << " " << fVolumeID3 << " " << 
  //                                 fPos.X() << " " << fPos.Y() << " " << fPos.Z() << " " << 
  //                                 fMom.Px() << " " << fMom.Py() << " " << fMom.Pz() << " " << 
  //                                 fTime << " " << fLength << " " << fELoss << " path = " << fNodePath <<"\n";
  
  new(clref[size]) SpdEcalECPoint(fTrackID, 
...
//_____________________________________________________________________________________
void SpdEcalEC::EndOfEvent()
{
   Reset();
}

//_____________________________________________________________________________________
void SpdEcalEC::FinishRun() 
{
...
//_____________________________________________________________________________________
void SpdEcalEC::ConstructGeometry()
{   
   ...
   SpdEcalECGeoMapper* mapper = dynamic_cast<SpdEcalECGeoMapper*>(fGeoMapper);
   ...
   cout << "\n*******************************************************************************" << endl;
   cout << "********************** SpdEcalEC::ConstructGeometry *************************" << endl;
...
void SpdEcalEC::BuildEndcap()
{
   ...
   if (nCellsXY >= 1000) {
       cout << "-E- <SpdEcalEC::ConstructGeometry_1> "
...
//_____________________________________________________________________________________
SpdGeoMapper* SpdEcalEC::GetMapper() 
{
   ...
   // search for mapper
   fGeoMapper = factory->SearchForMapper("SpdEcalECGeoMapper");
   
   // create default mapper
   if (!fGeoMapper) fGeoMapper = factory->Mapper("SpdEcalECGeoMapper");
    
   return fGeoMapper;
}

//_____________________________________________________________________________
Bool_t SpdEcalEC::LoadParsFrom(SpdParSet* params) 
{
...
//_____________________________________________________________________________________
TString SpdEcalEC::GetDataOut(Int_t n) const 
{ 
...
//_____________________________________________________________________________________
TClonesArray* SpdEcalEC::GetCollection(Int_t iColl) const 
{ 
...
//_____________________________________________________________________________________
Double_t SpdEcalEC::GetCapacity() const 
{ 
...
//_____________________________________________________________________________________
Double_t SpdEcalEC::GetMass() const 
{ 
   return (fEndcap) ? GetCapacity()*GetDensity() : 0;
}

//_____________________________________________________________________________________
Double_t SpdEcalEC::GetDensity() const 
{   
   return (fEndcap) ? fEndcap->GetMaterial()->GetDensity() : 0; 
} 

//_____________________________________________________________________________
void SpdEcalEC::Print(Option_t*) const
{
   SpdDetector::Print("");
