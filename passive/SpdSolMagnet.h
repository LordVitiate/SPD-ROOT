...
#ifndef __SPDSOLMAGNET_H__
#define __SPDSOLMAGNET_H__
...
class SpdSolMagnet: public SpdPassiveModule {

public:

    SpdSolMagnet();
    SpdSolMagnet(const char* Name, const char* Prefix = "SPDSOLMAGNET");
    
    virtual ~SpdSolMagnet();
    ...
    FairModule* CloneModule() const { return new SpdSolMagnet(*this); }
...
private:
    ...
    Bool_t BuildSection2();
    
    Bool_t BuildCryostat1();
   
    ClassDef(SpdSolMagnet,1)
};

#endif  /* __SPDSOLMAGNET_H__ */
