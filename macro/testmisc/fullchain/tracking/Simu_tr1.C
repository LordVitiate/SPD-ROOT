...
//   run->AddModule(Magnet);
  ...
  SpdPrimaryGenerator* primGen = new SpdPrimaryGenerator();
      ...
      isogen1->Initialize(13,0.7,1);  // pdg number, momentum (GeV/c), particles per event or LEVEL
      ...
      isogen2->Initialize(-13,0.7,1);  // pdg number, momentum (GeV/c), particles per event or LEVEL
