...
void run_sim(Int_t nEvents = 1, TString mcEngine = "TGeant4")
{
...
// 
  ...
  // 0 = Transport generator 
  // 1 = Pythia (DEFAULT value)
  ...
  //P6gen->SetSeed(0); 
  //P6gen->SetSeed(48773556);
  //P6gen->SetSeed(40232415);
  //P6gen->SetSeed(18773556);
  //P6gen->SetSeed(16290987,1);
  //P6gen->SetSeed(12995); 
  //P6gen->SetSeed(263987);
  //P6gen->SetSeed(7813081,7);
  //P6gen->SetSeed(99974173);
  //P6gen->SetSeed(16290987,1);
  //P6gen->SetSeed(15610699, 5);
  //P6gen->SetSeed(13495);
  
  P6gen->SetSeed(127472,9);
