...
//     mvd_hits_producer->SetHitResolution(4, 800*mkm,  90*mkm); 
  ...
  track_finder->CheckMinItsHits(true,0);    // special for reco
//  track_finder->CheckMinItsHits(true,1);    // special for reco
//  track_finder->CheckMinItsHits(true,2);    // special for reco
//  track_finder->CheckMinItsHits(true,3);    // special for reco
  track_finder->CheckMinTsHits(true,0);     // special for rec
  track_finder->CheckMinHits(true,4);       // special for reco
  ...
  track_finder->CheckMaxPartGeneration(true,1);    // only primary particle  WTF???
//  track_finder->CheckMaxPartGeneration(true,2);    // only primary particle 
