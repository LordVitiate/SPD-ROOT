...
#ifndef __SPDRSSECHITPRODUCER_H__
#define __SPDRSSECHITPRODUCER_H__
...
class SpdRsSECHitProducer: public FairTask {
    
public:

    SpdRsSECHitProducer(TString params = "RsSECParSet");
    virtual ~SpdRsSECHitProducer();
...
private:
    ...
    ClassDef(SpdRsSECHitProducer,1)
};

#endif  /* __SPDRSSECHITPRODUCER_H__ */
