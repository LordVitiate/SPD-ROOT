...
#ifndef __SPDECALSECHIT_H__
#define __SPDECALSECHIT_H__
...
class SpdEcalSECHit : public FairHit {

public:

    SpdEcalSECHit(Int_t uid = -1);
    virtual ~SpdEcalSECHit();
...
private:
    ...
    ClassDef(SpdEcalSECHit,1)
};

#endif  /* __SPDECALSECHIT_H__ */
