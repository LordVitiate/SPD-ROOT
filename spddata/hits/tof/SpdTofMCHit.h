...
#ifndef __SPDTOFMCHIT_H__
#define __SPDTOFMCHIT_H__
...
class SpdTofMCHit: public SpdHit {
...
private:
    ...
    Int_t       fPdg;         // track PID (pdg number)
    ...
    ClassDef(SpdTofMCHit,1)
};

#endif  /* __SPDTOFMCHIT_H__ */
