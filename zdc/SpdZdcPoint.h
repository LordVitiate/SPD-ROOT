...
#ifndef __SPDZDCPOINT_H__
#define __SPDZDCPOINT_H__ 
...
class SpdZdcPoint : public FairMCPoint {
...
public:
  ...
  SpdZdcPoint(Int_t trackID, Int_t detID, Int_t modID,
  ...
  SpdZdcPoint(const SpdZdcPoint& point) { *this = point; }
...
private:
  ...
  ClassDef(SpdZdcPoint,1)
  
};

#endif  /* __SPDZDCPOINT_H__ */
