...
ClassImp(SpdTsTECPoint)

//_____________________________________________________________________________________
SpdTsTECPoint::SpdTsTECPoint():FairMCPoint(),
...
//_____________________________________________________________________________________
SpdTsTECPoint::SpdTsTECPoint(Int_t trackID, Int_t detID,
...
//_____________________________________________________________________________________
SpdTsTECPoint::SpdTsTECPoint(Int_t trackID, Int_t detID, Long_t detTID,
                             TVector3 posIn, TVector3 momIn, Double_t tofIn, 
                             Double_t length, Double_t eLoss)
:FairMCPoint(trackID, detID, posIn, momIn, tofIn, length, eLoss), 
...
//_____________________________________________________________________________________
SpdTsTECPoint::~SpdTsTECPoint() 
{ 
  
}

//_____________________________________________________________________________________
Double_t SpdTsTECPoint::GetPointDir(TVector3& dir) const 
{ 
...
void SpdTsTECPoint::GetPosTime(TVector3& pos, Double_t& t) const
{
...
//_____________________________________________________________________________________
void SpdTsTECPoint::Print(const Option_t* opt) const
{
  cout << "<SpdTsTECPoint::Print> " << endl; 
  cout << "\n";
