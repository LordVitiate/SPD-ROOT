...
#ifndef __SPDTSTECPOINT_H__
#define __SPDTSTECPOINT_H__ 
...
class SpdTsTECPoint : public FairMCPoint {
...
public:
  ...
  SpdTsTECPoint(Int_t trackID, Int_t detID, 
               TVector3 posIn, TVector3 momIn, Double_t tofIn, 
               Double_t length, Double_t ELoss);
  
  SpdTsTECPoint(Int_t trackID, Int_t detID, Long_t detTID,
               TVector3 posIn, TVector3 momIn, Double_t tofIn, 
               Double_t length, Double_t ELoss);
