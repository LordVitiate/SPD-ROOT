...
#ifndef __SPDTSTB_H__
#define __SPDTSTB_H__
...
class SpdTsTB: public SpdDetector { 

public:

    SpdTsTB(const char* Name, Bool_t Active);
    SpdTsTB();
    ...
    FairModule* CloneModule() const { return new SpdTsTB(*this); }
...
private:
    ...
    //SpdTsTB(const SpdTsTB&);
    SpdTsTB& operator=(const SpdTsTB&);
