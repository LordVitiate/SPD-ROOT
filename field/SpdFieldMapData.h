...
#ifndef __SPDMAGFIELDMAPDATA_H__
#define __SPDMAGFIELDMAPDATA_H__
...
class SpdFieldMapData {
  
public:
  
  SpdFieldMapData();
  SpdFieldMapData(const Char_t* name, const Char_t* type = "");

  virtual ~SpdFieldMapData();
